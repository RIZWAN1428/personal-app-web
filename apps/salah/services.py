...
def get_prayer_timings(city="Jaunpur", country="India", state="Uttar Pradesh", method=1, school=1, date_str=None):
    ...
    Returns a dictionary with timings, hijri date, gregorian date, and metadata.
    """
    params = {
        "city": city,
        "country": country,
    ...
    try:
        ...
        with urllib.request.urlopen(req, timeout=5) as response:
            ...
            if data.get("code") == 200:
                ...
                hijri_formatted = f"{hijri['day']} {hijri['month']['en']} {hijri['year']} AH"
...
def calculate_next_prayer(timings):
    ...
    prayers = [
        ...
        ("Sunrise", timings.get("Sunrise", "06:15")),
        ("Dhuhr", timings.get("Dhuhr", "12:30")),
        ("Asr", timings.get("Asr", "16:00")),
        ("Maghrib", timings.get("Maghrib", "18:30")),
        ("Isha", timings.get("Isha", "20:00")),
    ]
    ...
    return {
        ...
        "time": target_time_str if next_prayer else timings.get("Fajr", "05:00"),
